...
import styles from './GlobeWithPolygons.module.css';
import { Slider } from '@mui/material';

import earthMapping from '../../assets/images/country_outlines_4k.png';
...
main = () => {
  ...
  async function loadCountryData() {
    ...
    for (const countryInfo of countryInfos) {
      ...
      lonHelper.rotation.y = degrees_to_radians(lon) + lonFudge;
      latHelper.rotation.x = degrees_to_radians(lat) + latFudge;
...
resizeRendererToDisplaySize = (renderer) => {
  ...
  return needResize;
    ...
    render() {
        ...
        min={0}
        max={50}
        onChange={this.resizeRendererToDisplaySize()}
       />
       <Slider
        aria-label="Temperature"
        defaultValue={30}
